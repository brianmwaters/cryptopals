...
from cryptopals import challenge10
...
def test_challenge10():
    input_ = read_base64("files/challenge10/10.txt")
    ...
    assert challenge10.aes_cbc_decrypt(key, iv, input_) == solution
    assert challenge10.aes_cbc_encrypt(key, iv, solution) == input_
